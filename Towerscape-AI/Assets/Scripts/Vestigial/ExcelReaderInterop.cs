...
public class ExcelReaderInterop : MonoBehaviour {
    ...
    //public ExcelReaderInterop(string filePath) {
    //    if (filePath == null)
    ...
    //public ExcelReaderInterop(UnityEngine.Object file) : this(UnityEditor.AssetDatabase.GetAssetPath(file)){ }
